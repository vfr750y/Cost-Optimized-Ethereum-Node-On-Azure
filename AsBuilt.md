...
|   3    |  Create the Azure Service Principal (SPN) <br>az ad sp create-for-rbac --name "github-eth-node-sp" <br>--role contributor \
  --scopes /subscriptions/{subscription-id} <br>/resourceGroups/rg-lodestar-node \ <br>--json-auth  |  ![App Registration](./Screenshots/appregistration.png) ![Enterprise Application](./Screenshots/enterpriseapplication.png)|
