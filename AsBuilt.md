...
|   2    | Create the target resource group RG_NAME="rg-lodestar-node" \
 LOCATION="australiaeast" \
 az group create --name $RG_NAME --location $LOCATION                    | ![Resource Group](./Screenshots/resourcegroup.png)     |
